    ...
    if(deviceinfo){
        ...
        for (i = 0; i < deviceinfo.length; i++) {
            ...
            var ops = '<button type="button" class="btn btn-default device-inputs" data-vsn="' + device_sn + '" data-devname="\' + device_name + \'">浏览</button>'
                ...
                + '<li><a href="My_Gates_devices_outputs.html?sn='+ gate_sn + '&vsn=' + device_sn +'">数据下置</a></li>'
                + '<li><a href="My_Gates_devices_commands.html?sn='+ gate_sn + '&vsn=' + device_sn +'">指令下置</a></li>'
 ...
 *	获取网关中某个设备的实时数据
 */
function gate_devices_inputs(sn, vsn, tableobj){
